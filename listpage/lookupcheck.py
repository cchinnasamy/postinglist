...
Lookup_model_file = os.path.join(settings.PROJECT_ROOT, 'Lookup_data_new_v2.pickle')

#Lookup_model_file = "/Lookup_data_new_v2.pickle"
with open(Lookup_model_file, 'r') as f:
